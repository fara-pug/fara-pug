...
at these [[https://www.startpage.com/sp/search?query=FARA+Rougelike+youtube&cat=video][game-play vids]].

** Note
The is the start of 'rolling unannounced updates' via Github hosting.

I'm hosting these notes as a [[https://fara-pug.github.io/fara-pug/][web-page at github]] now, but that looks really lame. But
fear not! With [[https://github.com/fara-pug/fara-pug/blob/main/index.md][github stylesheets]] the notes look quite nice already. For the
full crazy, take a look at [[https://www.startpage.com/do/search?query=emacs+org+mode+outline+youtube][some vids]] then grab the source document [[https://github.com/fara-pug/fara-pug][from the
repo]].
...
- The [[Release Notes]] give insights into and context for additional commands.
...
you are a [[CAT WHISPERER]], but Mercs will listen to and obey you.
...
the dialogue options seem to make the most sense for a [[POLITICIAN]].
...
| Rune of      | Class | Type   | Effect                                                   |
|--------------+-------+--------+----------------------------------------------------------|
| Arrows       | s     | once   | Bypass Elemental Resistances                             |
| Blades       | s     | once   | +Crit%                                                   |
| Fonts        | s     | once   | entities in area add elemental component to their attack |
| Hammers      | s     | Malus  | Daze                                                     |
| Meteors      | s     | AOE    | Impact                                                   |
| Spears       | s     | once   | Damage+ with Range+                                      |
|--------------+-------+--------+----------------------------------------------------------|
| Burning      | e     | DOT    | Fire                                                     |
| Glamour      | e     | Stat   | +[[Charm][Charisma]]                                                |
| Slowness     | e     | Stat   | -[[Finesse][Finesse]]                                                 |
| Sickness     | e     | DOT    |                                                          |
| Intoxication | e     | DOT    | -[[Finesse][Finesse]] +Stumble%                                       |
| Bleeding     | e     | DOT    |                                                          |
|--------------+-------+--------+----------------------------------------------------------|
| Rejuvenation |       | Status | Healing over Time                                        |
| Shield       |       |        |                                                          |
| Beam         |       |        |                                                          |
| Meteor       |       |        |                                                          |
| Barrage      |       |        |                                                          |
...
:PROPERTIES:
:ID:       9af345c8-2a4b-4c50-94df-a5d239bed24c
:END:
...
** Scrolls
If I was an [[ARTIFICER]] I might know something about them. But I'm not. At this
...
| Class          | Class-Trait           |
|----------------+-----------------------|
| [[ADVENTURER][Adventurer]]     | Onward!               |
| [[ALCHEMIST][Alchemist]]      | Potent Potioner       |
| [[ARTIFICER][Artificer]]      | Spellgrafting         |
| [[BEEKEEPER][Beekeeper]]      | Ancient Resistance    |
| [[BLOODWEAVER][Bloodweaver]]    | Blood Pact            |
| [[BODYBUILDER][Bodybuilder]]    | Solar Flexus          |
| [[BOTANIST][Botanist]]       | Familiar Phytology    |
| [[CAT WHISPERER][Cat Whisperer]]  | Cat Person            |
| [[CHEF][Chef]]           | Gastromancy           |
| [[COMMANDER][Commander]]      | Galvanizer            |
| [[DEMON SLAYER][Demon Slayer]]   | Know Thy Foe          |
| [[DERVISH][Dervish]]        | Dangerous Dance       |
| [[DUELIST][Duelist]]        | En Garde              |
| [[EARTH ZEALOT][Earth Zealot]]   | Magnetic Slide        |
| [[ELEMANCER][Elemancer]]      | Arcane Prodigy        |
| [[ENGINEER][Engineer]]       | Fixer Upper           |
| [[EQUESTRIAN][Equestrian]]     | Brawler               |
| [[EXECUTIONER][Executioner]]    | Soothslayer           |
| [[FISHMONGER][Fishmonger]]     | Aquatic Inquisitor    |
| [[FORTUNE TELLER][Fortune Teller]] | Foresight             |
| [[GAMBLER][Gambler]]        | Luck of the Draw      |
| [[GAMESTALKER][Gamestalker]]    | Hawkeye               |
| [[GATEKEEPER][Gatekeeper]]     | Besiegement           |
| [[GUNSLINGER][Gunslinger]]     | Taegunsho             |
| [[HABERDASHER][Haberdasher]]    | Hats on to Me         |
| [[HOMESTEADER][Homesteader]]    | Sunriser              |
| [[ILLUSIONIST][Illusionist]]    | Now You See Me        |
| [[JUGGERNAUT][Juggernaut]]     | Unstoppable           |
| [[KENSAI][Kensai]]         | Samurai Showdown      |
| [[KUNG FU MASTER][Kung Fu Master]] | Fluid Movement        |
| [[MAD SCIENTIST][Mad Scientist]]  | Gone Too Far          |
| [[PLAGUE DOCTOR][Plague Doctor]]  | Epidemic              |
| [[POLITICIAN][Politician]]     | Polarize              |
| [[POTTER][Potter]]         | Earthen Bond          |
| [[PUGILIST][Pugilist]]       | The Greatest          |
| [[RAGAMUFFIN][Ragamuffin]]     | Sticky Fingers        |
| [[REAPER][Reaper]]         | Last Harvest          |
| [[RHAPSODIST][Rhapsodist]]     | Captivating Crescendo |
| [[RIFT DANCER][Rift Dancer]]    | Astral Calling        |
| [[SCHOLAR][Scholar]]        | Gift of Knowledge     |
| [[SCOUNDREL][Scoundrel]]      | Devious Plot          |
| [[SOLDIER][Soldier]]        | Dogged March          |
| [[SPELLTHIEF][Spellthief]]     | Intellectual Forgery  |
| [[TOURIST][Tourist]]        | Sightseer             |
| [[UNEMPLOYED][Unemployed]]     | Boundless Potential   |
| [[VIKING][Viking]]         | Thunderous Resilience |
| [[WILDHEART][Wildheart]]      | Killer Instincts      |
| [[WITCH][Witch]]          | Wicked Form           |
| [[WRESTLER][Wrestler]]       | Muscle Spirit         |
|----------------+-----------------------|

See also Class-traits info in the [[2020.12.11 After 568 Days, Public Alpha 15 is LIVE!][Alpha15 release notes]]

Now, if only we had a list of those damn manuals! You could be planning instead
of risking [[Blights][Anihilation]] by actually playing the game!
...
| Sand           |                  | /dig        |
| Stone          |                  | find        |
| Birds          | Tuft of Feathers | drops       |
| Mounds of Clay | Lumps            |             |
| Ceramic Plates | Clay             | /dig?       |
| Logs           | Wooden Planks    | /harvest    |
| Logs           | Wooden Blocks    | /harvest    |
| Burlap         | 2 Plant Fibers   | Very Common |
|----------------+------------------+-------------|
...
- Might be cheaper to hunt for [[Ruins][ruinous ruins]] since they are the only place i've
