...
| "Normal"    | Totally regular average in all Stats |
|-------------+--------------------------------------|
...
| [[https://www.startpage.com/sp/search?query=dark+alchemy][Dark]]    |  Sinister?     |
|---------+--------|
...
- Cheapest and most thrilling to hunt for [[Ruins][ruinous ruins]] since you'll likely
  ...
  notes for the [[Location List][Location List]] to tweak the [[Difficulty][Difficulty]].
