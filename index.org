...
- Latest [[https://brianiscreative.itch.io/fara/devlog][Devlog]], [[https://discord.gg/FEp52yj][Discord]], [[https://fara.fandom.com/wiki/Special:RecentChanges?hidebots=1&limit=100&days=90&enhanced=1&urlversion=2][Wiki-Updates]], [[https://brianiscreative.itch.io/fara/community][Itch-Posts]].
- Goto [[Guides to the current version][Guides to this and older versions]].
...
** Traps
- Classes that love them Engineer, Scoundrel.

|Types

any hard material.

- "Defuser" Trait from Jade Faction makes them much easier to disarm
- Search should find them all, yet sometimes you miss one.
...
and from several types of [[Bottles][containers]].
...
- Found in the wilderness, woods usually.
...
Outdoors; sleeping next to a firepit/campfire/torch on your cloak; climb and 
sleep atop a tree.
